  ...
  public: {
    Tables: {
      ...
      surelc_links: {
        ...
        Relationships: [
          {
            foreignKeyName: "surelc_links_created_by_fkey";
            columns: ["created_by"];
            isOneToOne: false;
            referencedRelation: "active_user_profiles";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "surelc_links_imo_id_fkey";
            columns: ["imo_id"];
            isOneToOne: false;
            referencedRelation: "imos";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "surelc_links_owner_user_id_fkey";
      ...
      user_targets: {
        Row: {
          ...
          nto_buffer_rate: number;
          persistency_13_month_target: number | null;
          persistency_25_month_target: number | null;
          persistency_assumption: number;
          premium_stat_preference: string;
