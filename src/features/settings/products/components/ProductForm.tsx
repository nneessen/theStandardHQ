...
export function ProductForm({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-3xl p-4 bg-card border-border">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleSubmit)}>
                      ...
                      <FormItem className="flex flex-col space-y-1">
                        ...
                        <div className="relative">
                          <Button
                            ...
                            className="w-full justify-between h-7 text-[11px] bg-card border-border"
                            onClick={() =>
                          ...
                          {carrierSearchOpen && (
                            <div className="absolute z-50 mt-1 w-full rounded-md border border-border bg-card p-0 shadow-md">
                              <Command>
                                <CommandInput
              ...
              {form.watch("product_type") === "term_life" && (
                <>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-5 gap-2 p-3 bg-background rounded-lg border border-border">
                      {VALID_TERM_LENGTHS.map((term) => (
                        <div key={term} className="flex flex-col gap-1">
                          ...
                          <Input
                            ...
                            placeholder="0"
                            disabled={isSubmitting}
                            className="h-7 text-[11px] text-center bg-card border-border"
            ...
            <DialogFooter className="gap-1 pt-3 border-t border-border/60 mt-3">
              <Button
                type="button"
                variant="outline"
                size="sm"
