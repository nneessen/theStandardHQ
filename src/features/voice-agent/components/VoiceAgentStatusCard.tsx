  ...
  return (
    <div className="rounded-lg border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900">
          ...
          <div className="flex flex-wrap gap-1.5">
            {featureLabels.map((feature) => (
              <Badge
                key={feature}
                variant="outline"
                className="border-zinc-200 bg-zinc-50 text-[9px] text-zinc-700 dark:border-zinc-700 dark:bg-zinc-950/40 dark:text-zinc-300"
              >
                {feature}
              </Badge>
            ))}
      ...
      {!voiceAccessAssigned && !effectiveEntitlement && !showServiceWarning && (
        <div className="mt-4 flex items-start gap-2 rounded-lg border border-zinc-200 bg-zinc-50 px-3 py-2 text-[11px] text-zinc-600 dark:border-zinc-800 dark:bg-zinc-950/40 dark:text-zinc-400">
