...
export function PromptPreviewPanel({ prompt }: PromptPreviewPanelProps) {
  if (!prompt.trim()) {
    return (
      <div className="rounded-xl border border-v2-ring bg-v2-canvas px-4 py-6 text-center dark:border-v2-ring dark:bg-v2-canvas/40">
  ...
  return (
    <div className="rounded-xl border border-v2-ring dark:border-v2-ring">
