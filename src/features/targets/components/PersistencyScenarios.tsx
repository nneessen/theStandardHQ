...
export function PersistencyScenarios({
  ...
  const getRowHighlight = (rate: number) => {
    ...
    if (difference < 1) return "bg-info/10"; // Highlight if within 1% of actual
    return "";
  };
  ...
  return (
    <div className="bg-v2-card rounded-v2-md border border-v2-ring shadow-v2-soft">
      ...
      <div className="p-3">
        {/* Explanation */}
        <div className="mb-3 p-2 bg-info/10 border border-info/20 rounded-lg flex items-start gap-2">
          <AlertCircle className="h-3 w-3 text-info mt-0.5 flex-shrink-0" />
          <div className="text-[10px] leading-relaxed text-info">
                ...
                return (
                  <TableRow
                    ...
                    className={cn(
                      ...
                      isCustom && "ring-1 ring-info ring-inset",
                    )}
                  >
        ...
        <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-2">
          ...
          <div className="p-2 rounded-md bg-v2-ring">
            ...
            <div className="text-[11px] font-mono font-bold text-destructive">
