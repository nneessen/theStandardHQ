            ...
            <Table>
              <TableHeader>
                <TableRow className="border-b border-zinc-200 dark:border-zinc-800">
                  <TableHead className="w-[30%] text-[10px] uppercase tracking-wider font-bold text-zinc-500 dark:text-zinc-400">
                    Agent
                  </TableHead>
                  <TableHead className="text-[10px] uppercase tracking-wider font-bold text-zinc-500 dark:text-zinc-400">
                    Progress
                  </TableHead>
                  <TableHead className="text-right text-[10px] uppercase tracking-wider font-bold text-zinc-500 dark:text-zinc-400">
                    Done
                  </TableHead>
                  <TableHead className="text-right text-[10px] uppercase tracking-wider font-bold text-zinc-500 dark:text-zinc-400">
                    Active
