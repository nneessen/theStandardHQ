...
export default function PresentationRecordPage() {
  ...
  return (
    <div className="h-[calc(100vh-4rem)] flex flex-col p-3 space-y-3">
      {/* Header */}
      <div className="flex items-center gap-2 bg-v2-card rounded-lg px-3 py-2 border border-v2-ring dark:border-v2-ring">
        <Button
          variant="ghost"
          size="icon"
          className="h-7 w-7"
          ...
          {mode === "record" && (
            <div className="space-y-3">
              <Button
                variant="ghost"
                size="sm"
                className="h-6 text-[11px] text-v2-ink-muted"
                onClick={() => {
                  setMode("choose");
