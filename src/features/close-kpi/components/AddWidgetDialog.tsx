          ...
          {filtered.map((entry) => {
            ...
            return (
              <button
                ...
                disabled={!!addingType}
                className={cn(
                  "flex items-start gap-2 rounded-md border border-zinc-200 dark:border-zinc-800 p-2 text-left transition-all",
                  "hover:border-zinc-400 dark:hover:border-zinc-600 hover:bg-zinc-50 dark:hover:bg-zinc-800/50",
                  "disabled:opacity-60 disabled:cursor-not-allowed",
                )}
              >
                <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded bg-zinc-100 dark:bg-zinc-800">
                  {isAdding ? (
